...
export default function Sultankudarattable(props) {
    ...
    const currentData = props.sultanKudaratData? props.sultanKudaratData.slice(startIndex, endIndex):'';
    ...
    return (
      <div>
        ...
        <div className="mt-4 flex justify-center gap-10">
          ...
          <button
            onClick={nextPage}
            disabled={currentPage === Math.ceil(props.sultanKudaratData?props.sultanKudaratData.length:'' / itemsPerPage)}
            className="bg-navy-primary text-white px-4 py-2 rounded-md disabled:bg-gray-300 hover:bg-opacity-95"
          >
            Next
          </button>
